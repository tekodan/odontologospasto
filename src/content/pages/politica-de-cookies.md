---
title: "Política de Cookies y Datos Personales"
description: "Última actualización: 20 de junio de 2026. Conoce cómo Odontólogos Pasto trata tus datos personales y utiliza cookies, en cumplimiento de la Ley 1581 de 2012 de Colombia."
---
...
- **Nombre:** Maryllen Guevara Márquez
- **Cédula y Licencia profesional N°:** 1151934866
- **Actúa como persona natural** bajo el nombre comercial **Odontólogos Pasto**.
- **Dirección:** Cra 34 #19-76, Pasto, Nariño, Colombia.
- **Teléfono:** +57 310 536 7290
- **Correo electrónico:** guevaramarquezmaryllen071448@gmail.com

## 2. ¿Qué datos personales recolectamos?

En este sitio web recolectamos dos tipos de información:

- **Datos de navegación y cookies:** dirección IP, tipo de navegador, páginas visitadas, duración de la visita, comportamiento de clicks, identificadores publicitarios de Google.
- **Datos proporcionados voluntariamente:** nombre, número de teléfono y mensaje que nos compartes al contactarnos por WhatsApp.

No recolectamos datos sensibles (origen racial, salud, orientación política, etc.) a través de este sitio.
...
No vendemos, no alquilamos y no compartimos tus datos personales con terceros, salvo obligación legal o con tu autorización expresa.

## 4. ¿Cuáles son tus derechos como titular de los datos?

De conformidad con el **artículo 17 de la Ley 1581 de 2012**, tienes los siguientes derechos:

- **Conocer, actualizar y rectificar** tus datos personales.
- **Solicitar prueba de la autorización** otorgada para el tratamiento.
- **Ser informado** sobre el uso dado a tus datos.
- **Presentar quejas** ante la Superintendencia de Industria y Comercio (SIC) por infracciones a la ley.
- **Revocar la autorización** y/o **solicitar la supresión** de tus datos cuando consideres que no se respetan tus derechos.
...
- **Correo electrónico:** [guevaramarquezmaryllen071448@gmail.com](mailto:guevaramarquezmaryllen071448@gmail.com)
- **WhatsApp:** [+57 310 536 7290](https://api.whatsapp.com/send?phone=573105367290)

Responderemos tu solicitud en un plazo máximo de **10 días hábiles** contados a partir de su recepción.
...
El tratamiento de datos personales en este sitio se realiza en cumplimiento de la legislación colombiana, en particular:

- **Ley 1581 de 2012** — Protección de datos personales.
- **Decreto 1377 de 2013** — Reglamentario de la Ley 1581.
- **Ley 1266 de 2008** — Habeas data financiero (cuando aplique).
- **Ley 1480 de 2011** — Estatuto del consumidor (en lo referente a comercio electrónico).
